    ...
    <div className="flex min-h-screen bg-background text-white font-sans selection:bg-accent-purple selection:text-white">
      ...
      >
        ...
        <nav className="flex-1 space-y-2">
          <SidebarLink to="/" icon={<Activity size={18} />} label="Overview" />
          <SidebarLink to="/users" icon={<Users size={18} />} label="Users" />
          <SidebarLink to="/fraud" icon={<ShieldAlert size={18} />} label="Fraud Alerts" />
          <SidebarLink to="/reports" icon={<FileText size={18} />} label="Reports" />
